...
<!-- СТРАНИЦА ПРОСМОТРА ВСЕХ ОБЪЯВЛЕНИЙ КВАРТИР -->
       ...
       <?php if (!empty($tickets)) { ?>
		...
		<div class="row" style="overflow:hidden; float:right; font-family:Tahoma;">
			<div class="col-12" style="float:left; text-align:left; margin-left:0px; margin-right: 10px;"><b style="font-size:16px;">Выбор по: </b></div>
			<div style="clear:both;"></div>
			<div class="col-12" style="font-size:16px;">
				<div class="btn btn-success" style="background-color:#28a74594; float:left; margin-right:6px; <?php if ($sort=='price') { ?>font-weight:bold; background-color: #28a745;<?php } ?>"><a href="http://<?php echo $_SERVER['HTTP_HOST'] . '/' . $uri_no_page_and_sort;?>/sort=price" style="color:white;">Цене</a></div>
				<div class="btn btn-success" style="background-color:#28a74594; float:left; margin-right:6px; <?php if ($sort=='square') { ?>font-weight:bold; background-color: #28a745;<?php } ?>"><a href="http://<?php echo $_SERVER['HTTP_HOST'] . '/' . $uri_no_page_and_sort;?>/sort=square" style="color:white;">Площади</a></div>
				<div class="btn btn-success" style="background-color:#28a74594; float:left; margin-right:6px; <?php if (($sort!='square') and ($sort!='price')) { ?>font-weight:bold; background-color: #28a745;<?php } ?>"><a href="http://<?php echo $_SERVER['HTTP_HOST'] . '/' . $uri_no_page_and_sort;?>/sort=date" style="color:white;">Дате</a></div>
				<div style="clear:both;"></div>
		</div>
		<div style="clear:both;"></div>
      </ol>
		...
		<div class="estates col-lg-12 col-md-12 col-sm-12 col-12" style="height: auto">
			...
			?>
			<h4 class="my-3"><b><?php if ($ticket['num_rooms_id']) if ($ticket['type_name']=='Квартира'){  $ticket['type_name']=mb_strtolower($ticket['type_name'], "UTF-8");?>
			...
			<div class="estate row" style="background: white url(/themes/theme_1.0/img/<?php echo $bg_img; ?>) right bottom no-repeat;">
				<div class="estateImgCont col-6 col-lg-6 col-md-6" style="padding: 0px;">
										<?php if ($img!='_no_image') { ?><div class="estateImg"><img class="card-img-top" style="width:100%; padding: 0px; max-height: 300px;" src="/uploads/images/realty/mini/<?php echo $img; ?>" /></div><?php } else { ?>
										<div class="estateImg"><img  style="width: 100%;" src="/themes/theme_1.0/img/no_imgs.jpg" /></div><?php } ?>
				
				</div>
				<div class="estateInfz1 col-6 col-md-6 col-lg-6">
				<div>
          
          
          <h5><?php echo $ticket['price']; ?> руб.</h5>
          <ul class="list-group list-group-flush">
            ...
            <?php } ?>
					...
					<a href="<?php echo SITE_URL . '/realty/cities/districts/all/' . 'all-' . $ticket['id'];?>" style="color:white !important; text-decoration:none !important;"><div class="h5 btn btn-primary" style="position:inherit !important; margin-top:10px;">Смотреть</div></a>					
