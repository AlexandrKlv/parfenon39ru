		...
		foreach($items as $item) {
			...
			if (strpos($_SERVER['REQUEST_URI'], '/admin')===FALSE){
				if ($this->is_active($item['url'])) {
					$this->menu .= '<li><img src="/themes/theme_1.0/img/bullet.jpg" style="padding-top:3px;"></li><li class="current"><a href="' . $item['url'] . '">' . $item['name'] . '</a>';
				} else {
					$this->menu .= '<li><img src="/themes/theme_1.0/img/bullet.jpg" style="padding-top:3px;"></li><li><a href="' . $item['url'] . '">' . $item['name'] . '</a>';
				}
			} else {
				if ($this->is_active($item['url'])) {
